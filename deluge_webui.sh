...
#####################################################
## Translated by: JohnTheBoss - 2015-08-23		   ##
#####################################################
## setup variables ##
latest="https://raw.githubusercontent.com/JohnTheBoss/Deluge_WebUI_Install_Script/master/deluge/deluge-1.3.11.tar.gz"
geoip="https://github.com/JohnTheBoss/Deluge_WebUI_Install_Script/raw/master/GeoIP/GeoIP.dat.gz"
...
# Check if we're root
if [ $(whoami) != "root" ]; then
        echo "Kerlek futtasd a scriptet root-kent!"
        echo "Hasznald 'sudo ./deluge_web.sh' parancsot, majd ird be a jelszavad."
        exit 1
fi
clear
## get packages required to build deluge ##
echo "Szukseges csomagok telepitese folyamatban....."
	apt-get update -qq
	apt-get upgrade -qqy
...
## install deluge ##
	echo " Deluge telepitese folyamatban...."
...
## install geoip database to resolve ips ##
	echo " GeoIP adatbazis telepitese folyamatban...."
	wget $geoip
	gzip -d GeoIP.dat.gz
...
## setup deluge user
	echo "Most add meg, hogy ki legyen az uj felhasznalo"
	read -p "Mi legyen a felhasznalonev?   " USERNAME
...
echo "#####################################################"
echo "		A WebUI-t az alabbi cimen erheted el:"
echo "					http://$ip:8112/ "
echo "       Alapertelmezett jelszo = deluge"
echo "#####################################################"
echo "#####################################################"
